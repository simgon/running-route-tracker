...
import { AnimationType, RouteAnimationConfig } from '../hooks/useRouteAnimation';
        ...
        <Tooltip title={isAnimating ? 'アニメーション停止' : 'アニメーション開始'}>
          <IconButton
            ...
            sx={{
              ...
              color: 'white',
              '&:hover': {
                backgroundColor: isAnimating ? theme.palette.error.dark : theme.palette.primary.dark,
              },
            }}
          >
                ...
                <Tooltip key={colorOption.value} title={colorOption.label}>
                  <IconButton
                    ...
                    sx={{
                      ...
                      border: config.color === colorOption.value ? '3px solid #000' : '1px solid #ccc',
                      '&:hover': {
                        backgroundColor: colorOption.color,
                        opacity: 0.8,
                      },
